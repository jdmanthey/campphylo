options(scipen=999)
project_directory <- "/lustre/scratch/jmanthey/08_ant_phylo/05_filtered_vcf"
directory_name <- "33_stats"
cluster <- "nocona"
max_number_jobs <- 800
...
vcf_header <- paste0(project_directory, "/scaffold0031.recode.vcf.gz")
...
ref_index <- read.table("camp_sp_genome_filtered.fasta.fai", stringsAsFactors=F)
